var staticCacheName = 'mws-stage-1';
var contentImgsCache = 'mws-stage-1-images';
var allCaches = [
  staticCacheName,
  contentImgsCache
];
...
/**
 * Strip suffix and extension of the image request url to match cache key
 * regardless of the image size requested.
 */
function serveImage(request) {
  var storageUrl = request.url.replace(/-small\.jpg$|-large\.jpg$/, '');
